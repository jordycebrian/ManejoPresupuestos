    ...
    public class TransaccionesController:Controller
    {
        ...
        public async Task<IActionResult> Semanal(int mes, int año)
        {
            ...
            for(int i = 0;i < diasSegmentados.Count(); i++)
            {
                ...
                var fechaFinal = new DateTime(año, mes, diasSegmentados[i].Last());
                ...
                else
                {
                    ...
                    grupoSemana.FechaFin = fechaFinal;
                }
            }
        ...
        public async Task<FileResult> ExportarExcelPorMes(int mes, int año)
        {
            ...
            var transacciones = await repositorioTransacciones.ObtenerPorUsuarioId(
                new ParamtrosObtenerTransaccionesPorUsuario
                {
                    UsuarioId = usuarioId,
                    FechaInicio = fechaInicio,
                    FechaFin = fechaFin
            ...
            var nomrbreArchivo = $"Manejo presupuesto - {fechaInicio.ToString("MMM yyyy")}.xlsx";
            return GenerarExcel(nomrbreArchivo, transacciones);
        }
        ...
        public async Task<FileResult> ExportarExcelPorAño(int año)
        {
            ...
            var nombreArchivo = $"Manejo Presupuesto - {fechaInicio.Minute.ToString("yyyy")}.xlsx";
        ...
        [HttpGet]
        public async Task<FileResult> ExprtarExcelTodo()
        {
            ...
            var nombreArchiva = $"Manejo Presupuesto - {DateTime.Today.ToString("dd-MM-yyyy")}.xlsx";

            return GenerarExcel(nombreArchiva, transacciones);
        }
